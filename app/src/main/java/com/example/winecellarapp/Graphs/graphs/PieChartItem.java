...
public class PieChartItem extends ChartItem {
    ...
    private SpannableString generateCenterText() {
        SpannableString s = new SpannableString("MyCellar\ncreated by\nSmartCellar");
        s.setSpan(new RelativeSizeSpan(1.6f), 0, 8, 0);
        s.setSpan(new ForegroundColorSpan(ColorTemplate.JOYFUL_COLORS[0]), 0, 8, 0);
        s.setSpan(new RelativeSizeSpan(.9f), 8, 19, 0);
        s.setSpan(new ForegroundColorSpan(Color.GRAY), 8, 19, 0);
